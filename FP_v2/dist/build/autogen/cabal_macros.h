...
/* package FPv2-0.1.0.0 */
#define VERSION_FPv2 "0.1.0.0"
#define MIN_VERSION_FPv2(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "FPv2-0.1.0.0-Apb67UextewLOsO2oYAuvE"

#define CURRENT_PACKAGE_KEY "FPv2-0.1.0.0-Apb67UextewLOsO2oYAuvE"
